...
import { createBooking, getBookings, approveBooking, rejectBooking, cancelBooking, setBookingDiscount } from '../controllers/bookings.controller.js';
...
export async function bookingsRoutes(app: FastifyInstance): Promise<void> {
  ...
  app.patch('/bookings/:id/discount', { preHandler: [authenticate] }, setBookingDiscount);
}
